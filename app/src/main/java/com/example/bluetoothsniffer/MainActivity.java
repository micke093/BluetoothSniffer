            ...
            if (!mScanning) {
                ...
                if (pairedDevices.size() > 0) {
                    ...
                    for (BluetoothDevice device : pairedDevices) {
                        ...
                        if (deviceName != null
                                && deviceName.contains(BBC_MICRO_BIT)
                ...
                mBluetoothAdapter.startLeScan(mLeScanCallback); //this does not work at all on any of my devices, they both run android 8.1 / 9 and get
